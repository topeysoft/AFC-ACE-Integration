...
echo -e "   ${YELLOW}python3 utilities/detect_ace_devices.py --generate-config > ${AFC_CONFIG_DIR}/ACE_units.cfg${NC}"
echo ""
echo "2. Edit the generated configuration as needed:"
echo -e "   ${YELLOW}nano ${AFC_CONFIG_DIR}/ACE_units.cfg${NC}"
echo ""
echo "3. Include AFC-ACE config in your printer.cfg:"
echo -e "   ${YELLOW}[include AFC/*.cfg]${NC}"
echo -e "   ${YELLOW}[include AFC/ACE_units.cfg]${NC}"
echo ""
