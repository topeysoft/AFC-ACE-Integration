...
def generate_config():
    ...
    print("# AFC-ACE Configuration")
    print("# Auto-generated by detect_ace_devices.py")
    print("# Copy this to ~/printer_data/config/AFC/ACE_units.cfg")
    print()
    print("# ============================================================")
    print(f"# Found {len(devices)} ACE device(s)")
    print("# ============================================================")
    ...
    print()
    print("# Next steps:")
    print("# 1. Copy this config to ~/printer_data/config/AFC/ACE_units.cfg")
    print("# 2. Add [include AFC/ACE_units.cfg] to your printer.cfg")
...
Examples:
  ...
  python3 detect_ace_devices.py --generate-config > ~/printer_data/config/AFC/ACE_units.cfg
        '''
    )
